...
import userinterface.CompoundSupplierRole.CompoundSupplierWorkAreaJPanel;

/**
 *
 * @author Pushkar
 */
public class CompoundSupplierRole extends Role {
     @Override
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, EcoSystem business,DiseaseDirectory diseaseDirectory,Network network) {
        return new CompoundSupplierWorkAreaJPanel(userProcessContainer, account, (CompoundSupplierOrganization)organization, (DrugManufacturingEnterprise)enterprise);
    }
}
